...
/*
fopen_bin: binaris read writettal operál.
HF: binaris rutin szerzése: binárisan próbáljunk számokat ésszövegeket kiirni.
struct : adatmezők,metódusok, public adatmezők, alapötlet ne legyen metódus c ben mert elhasal.
struktúrát is írjunk fileba binárisan.
*/