...
int main(int argc,char** argv){
 ...
 char c;
 while (read(f,&c,sizeof(c))){  //0 logikai értéke logikailag , hamis(shell:fordított)
    //read gives back the number of bytes, hány bájtot teljesített
    //1. parameter the file descriptor, filemutató
...
/*
	filekezelés, open/fopen
	--------------------------
	std_in, std_out,std_r: bináris írás memória címről olvas és oda ír.
	read/write : biteonként ír olvas,
	int 0--> 0000 bitesort jelent
